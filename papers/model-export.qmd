...
female_final_reduced_model <- glm(highbp14090_adj ~ rcs(clc_age, 4) + fmh_15 + rcs(clc_age, 4)*rcs(hwmdbmi, 3) + rcs(clc_age, 4)*diabx, family = quasibinomial(), data = female_data, weights = wgt_full)
...
male_safe_model <- create_safe_export(male_model, male_data_summary, glm_model = male_final_model)
female_safe_model <- create_safe_export(female_model, female_data_summary, glm_model = female_final_model)
male_safe_reduced_model <- create_safe_export(male_reduced_model, male_data_summary, glm_model = male_final_reduced_model)
female_safe_reduced_model <- create_safe_export(female_reduced_model, female_data_summary, glm_model = female_final_reduced_model)
...
male_safe_reduced_model$formula <- highbp14090_adj ~ rcs(clc_age, 4) + fmh_15 + rcs(clc_age, 4)*rcs(hwmdbmi, 3) + rcs(clc_age, 4)*diabx
female_safe_reduced_model$formula <- highbp14090_adj ~ rcs(clc_age, 4) + fmh_15 + rcs(clc_age, 4)*rcs(hwmdbmi, 3) + rcs(clc_age, 4)*diabx
