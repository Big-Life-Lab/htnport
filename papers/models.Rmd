...
# Merge bootstrap weights to imputed sample data, which is then segregated and weighted
...
weighted_male_nofmh$degf <- 68
male_reduced_model_nomfh <- survey::svyglm(highbp14090_adj ~ rcs(clc_age, 4) + rcs(clc_age, 4)*rcs(whr, 3) + rcs(clc_age, 4)*diabx, design = weighted_male_nofmh, family = quasibinomial())

weighted_female_nofmh$degf <- 68
female_reduced_model_nomfh <- survey::svyglm(highbp14090_adj ~ rcs(clc_age, 4) + rcs(clc_age, 4)*rcs(hwmdbmi, 3) + rcs(clc_age, 4)*diabx, design = weighted_female_nofmh, family = quasibinomial())
...
# Merge bootstrap weights to unimputed sample data, which is then segregated and weighted
...
unimputed_weighted_male$degf <- 68
unimputed_male_reduced_model <- survey::svyglm(highbp14090_adj ~ rcs(clc_age, 4) + rcs(clc_age, 4)*rcs(whr, 3) + rcs(clc_age, 4)*diabx, design = unimputed_weighted_male, family = quasibinomial())

unimputed_weighted_female$degf <- 68
unimputed_female_reduced_model <- survey::svyglm(highbp14090_adj ~ rcs(clc_age, 4) + rcs(clc_age, 4)*rcs(hwmdbmi, 3) + rcs(clc_age, 4)*diabx, design = unimputed_weighted_female, family = quasibinomial())
