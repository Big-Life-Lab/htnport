...
cycle1_prescription_data <- rec_with_table(cycle1, c("atc_101a", "mhr_101b"), variable_details = my_variable_details, log = TRUE)
head(cycle1_prescription_data)

cycle3_prescription_data <- rec_with_table(cycle3, c("meucatc", "npi_25b"), variable_details = my_variable_details, log = TRUE)
head(cycle1_prescription_data)
...
head(cycle1_ace_prescription_data) # 3 out of the 4 participants use ACE inhibitors based on info from 40 of their medications
