...
#   agegroup4 = sample(c("2039", "4059", "6069", "7079"), 1000, replace = TRUE), # FIXED ROW COUNT
...
write.csv(male_final_betas, file = "P:/10619/Dropbox/htnport/vignettes/male-final-betas.csv")
write.csv(female_final_betas, file = "P:/10619/Dropbox/htnport/vignettes/female-final-betas.csv")
```
...
male_shap_values$results <- male_shap_values$results[male_shap_values$results$feature != "highbp14090_adj", ]
