...
for (var in rcs_variables) {
  ...
  print(plot(predict_response(male_final_model, terms = var, ci_level = NULL)) +
    labs(title = NULL, x = x_label, y = "Predicted probability of hypertension"))
...
for (var in age_cat_int_variables) {
  ...
  print(plot(predict_response(male_final_model, terms = c("clc_age", var), ci_level = NULL)) + labs(title = NULL, x = "Age (years)", y = "Predicted probability of hypertension",
         colour = legend_label) +
    scale_color_discrete(name = legend_label, labels = level_labels[[var]]))
  
  print(plot(predict_response(female_final_model, terms = c("clc_age", var), ci_level = NULL)) + labs(title = NULL, x = "Age (years)", y = "Predicted probability of hypertension",
         colour = legend_label) +
    scale_color_discrete(name = legend_label, labels = level_labels[[var]]))
}
...
# BMI x WHR plots
print(plot(predict_response(male_final_model, terms = c("hwmdbmi", "whr"), ci_level = NULL)) + labs(title = NULL, x = "Body mass index (kg/m²)", y = "Predicted probability of hypertension", colour = "Waist-to-height ratio (%)"))
  
print(plot(predict_response(female_final_model, terms = c("hwmdbmi", "whr"), ci_level = NULL)) + labs(title = NULL, x = "Body mass index (kg/m²)", y = "Predicted probability of hypertension", colour = "Waist-to-height ratio (%)"))
```