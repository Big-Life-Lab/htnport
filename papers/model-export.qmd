...
weighted_female_c$degf <- 68
female_reduced_model_c <- survey::svyglm(highbp14090_adj ~ clc_age_rcs_1_C + clc_age_rcs_2_C + clc_age_rcs_3_C + fmh_15_1_C + hwmdbmi_rcs_1_C + hwmdbmi_rcs_2_C + diabx_1_C + clc_age_rcs_1_by_hwmdbmi_rcs_1_C + clc_age_rcs_2_by_hwmdbmi_rcs_1_C + clc_age_rcs_3_by_hwmdbmi_rcs_1_C +  clc_age_rcs_1_by_hwmdbmi_rcs_2_C + clc_age_rcs_2_by_hwmdbmi_rcs_2_C + clc_age_rcs_3_by_hwmdbmi_rcs_2_C + clc_age_rcs_1_by_diabx_1_C + clc_age_rcs_2_by_diabx_1_C +
...
male_safe_model <- create_safe_export(male_model_c)
female_safe_model <- create_safe_export(female_model_c, female_data_summary)
male_safe_reduced_model <- create_safe_export(male_reduced_model_c, male_data_summary)
female_safe_reduced_model <- create_safe_export(female_reduced_model_c, female_data_summary)

# 4. Validate with opposite data before saving
validate_export(male_model_c, male_safe_model, female_data_c)
validate_export(female_model_c, female_safe_model, male_data_c)
validate_export(male_reduced_model_c, male_safe_reduced_model, female_data_c)
validate_export(female_reduced_model_c, female_safe_reduced_model, male_data_c)
...
saveRDS(male_safe_model, file = "P:/10619/Dropbox/htnport/models/svyglm-centered/male_model.rds")
saveRDS(female_safe_model, file = "P:/10619/Dropbox/htnport/models/svyglm-centered/female_model.rds")
saveRDS(male_safe_reduced_model, file = "P:/10619/Dropbox/htnport/models/svyglm-centered/male_reduced_model.rds")
saveRDS(female_safe_reduced_model, file = "P:/10619/Dropbox/htnport/models/svyglm-centered/female_reduced_model.rds")
```
...
male_safe_reduced_model <- readRDS("P:/10619/Dropbox/htnport/models/svyglm-centered/male_reduced_model.rds")
female_safe_reduced_model <- readRDS("P:/10619/Dropbox/htnport/models/svyglm-centered/female_reduced_model.rds")
