...
### Model presentation - partial effect plots
...
### Model presentation - parameters

```{r, warning = FALSE, message = FALSE}
# Get beta coefficients for final models
...
### Model presentation - Shap plot (full model)
...
### Model presentation - Shap plot (reduced model)
...
### Model presentation - Shap-adjusted ORs and CIs (full models only)
