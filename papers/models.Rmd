...
### Model presentation - final beta coefficients

```{r, warning = FALSE, message = FALSE}
# Set originally svyglm-fit full models as final models
male_final_model <- male_model
female_final_model <- female_model

# Get beta coefficients for final models
male_final_betas <- extract_beta_coefs(male_final_model)
female_final_betas <- extract_beta_coefs(female_final_model)

# Export beta coefficient tables as csv files
write.csv(male_final_betas, file = "P:/10619/Dropbox/htnport/vignettes/Model Presentation Output/Male Final Model Betas.csv")
write.csv(female_final_betas, file = "P:/10619/Dropbox/htnport/vignettes/Model Presentation Output/Female Final Model Betas.csv")
```

### Model presentation - contribution of predictors for observation with Shap
...
### Model presentation - Shap-adjusted ORs and CIs
