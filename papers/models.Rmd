...
write.csv(male_summary_1yr, file = "P:/10619/Dropbox/htnport/output/New Modelling Output/Model Presentation Output/Parameters/svyglm/Vascular Age/Male Vascular Age - 1 yr", row.names = TRUE)
write.csv(female_summary_1yr, file = "P:/10619/Dropbox/htnport/output/New Modelling Output/Model Presentation Output/Parameters/svyglm/Vascular Age/Female Vascular Age - 1 yr", row.names = TRUE)
...
write.csv(male_summary_5yr, file = "P:/10619/Dropbox/htnport/output/New Modelling Output/Model Presentation Output/Parameters/svyglm/Vascular Age/Male Vascular Age - 5 yrs", row.names = TRUE)
write.csv(female_summary_5yr, file = "P:/10619/Dropbox/htnport/output/New Modelling Output/Model Presentation Output/Parameters/svyglm/Vascular Age/Female Vascular Age - 5 yrs", row.names = TRUE)
```