...
for (var in rcs_variables) {
  ...
  # preds_male$odds <- preds_male$predicted / (1 - preds_male$predicted)
  # ref_row <- preds_male[which.min(preds_male$x), ]
  # ref_odds <- ref_row$odds
  # preds_male$or <- preds_male$odds / ref_odds
  # preds_male$or_low <- (preds_male$conf.low / (1 - preds_male$conf.low)) / ref_odds
  # preds_male$or_high <- (preds_male$conf.high / (1 - preds_male$conf.high)) / ref_odds
  # 
  # # Female
  # preds_female <- ggpredict(female_final_model, terms = var)
  # preds_female$odds <- preds_female$predicted / (1 - preds_female$predicted)
  # ref_row <- preds_female[which.min(preds_female$x), ]
  # ref_odds <- ref_row$odds
  # preds_female$or <- preds_female$odds / ref_odds
  # preds_female$or_low <- (preds_female$conf.low / (1 - preds_female$conf.low)) / ref_odds
  # preds_female$or_high <- (preds_female$conf.high / (1 - preds_female$conf.high)) / ref_odds
...
### Save and export all model objects

```{r}
# svyglm models
male_model$model <- NULL
female_model$model <- NULL
male_reduced_model$model <- NULL
female_reduced_model$model <- NULL

male_model$data <- NULL
female_model$data <- NULL
male_reduced_model$data <- NULL
female_reduced_model$data <- NULL

male_model$survey.design <- NULL
female_model$survey.design <- NULL
male_reduced_model$survey.design <- NULL
female_reduced_model$survey.design <- NULL

male_model$y <- NULL
female_model$y <- NULL
male_reduced_model$y <- NULL
female_reduced_model$y <- NULL

male_model$weights <- NULL
female_model$weights <- NULL
male_reduced_model$weights <- NULL
female_reduced_model$weights <- NULL

male_model$prior.weights <- NULL
female_model$prior.weights <- NULL
male_reduced_model$prior.weights <- NULL
female_reduced_model$prior.weights <- NULL

saveRDS(male_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/svyglm/male_model.rds")
saveRDS(female_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/svyglm/female_model.rds")
saveRDS(male_reduced_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/svyglm/male_reduced_model.rds")
saveRDS(female_reduced_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/svyglm/female_reduced_model.rds")

# glm models
male_final_model$model <- NULL
female_final_model$model <- NULL
male_final_reduced_model$model <- NULL
female_final_reduced_model$model <- NULL

male_final_model$data <- NULL
female_final_model$data <- NULL
male_final_reduced_model$data <- NULL
female_final_reduced_model$data <- NULL

male_final_model$y <- NULL
female_final_model$y <- NULL
male_final_reduced_model$y <- NULL
female_final_reduced_model$y <- NULL

male_final_model$weights <- NULL
female_final_model$weights <- NULL
male_final_reduced_model$weights <- NULL
female_final_reduced_model$weights <- NULL

male_final_model$prior.weights <- NULL
female_final_model$prior.weights <- NULL
male_final_reduced_model$prior.weights <- NULL
female_final_reduced_model$prior.weights <- NULL

saveRDS(male_final_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/glm/male_final_model.rds")
saveRDS(female_final_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/glm/female_final_model.rds")
saveRDS(male_final_reduced_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/glm/male_final_reduced_model.rds")
saveRDS(female_final_reduced_model, file = "P:/10619/Dropbox/htnport/vignettes/Model Objects/glm/female_final_reduced_model.rds")
```