...
saveRDS(male_safe_final_model, file = here::here("output", "reduced-models", "model-object", "male_reduced_model.rds"))
saveRDS(female_safe_final_model, file = here::here("output", "reduced-models", "model-object", "female_reduced_model.rds"))
```
...
male_safe_final_model <- readRDS(here::here("output", "reduced-models", "model-object", "male_reduced_model.rds"))
female_safe_final_model <- readRDS(here::here("output", "reduced-models", "model-object", "female_reduced_model.rds"))
...
male_validation_data <- read.csv(here::here("output", "reduced-models", "validation-data", "HTNPoRT-reduced-male-validation-data.csv"))
female_validation_data  <- read.csv(here::here("output", "reduced-models", "validation-data", "HTNPoRT-reduced-female-validation-data.csv"))
