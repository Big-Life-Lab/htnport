...
# Load bootstrap weights for each cycle and row bind them together before merging them to sample data
# cycle1_bsw <- read_stata("data/cycle1/cycle1_bsw.dta")
# cycle2_bsw <- read_stata("data/cycle2/cycle2_bsw.dta")
# cycle3_bsw <- read_stata("data/cycle3/cycle3_bsw.dta")
# cycle4_bsw <- read_stata("data/cycle4/cycle4_bsw.dta")
# cycle5_bsw <- read_stata("data/cycle5/cycle5_bsw.dta")
# cycle6_bsw <- read_stata("data/cycle6/cycle6_bsw.dta")
# names(cycle6_bsw) <- tolower(names(cycle6_bsw)) 

# cycles1to6_bsw <- rbind(cycle1_bsw, cycle2_bsw, cycle3_bsw, cycle4_bsw, cycle5_bsw, cycle6_bsw)

# cycles1to6_data <- dplyr::left_join(cycles1to6_data, cycles1to6_bsw, by = c("clinicid"))
```

## 5. Reobtain imputed data, segregrate such data by sex, weight all data, and center variables.
