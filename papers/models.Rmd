...
imputed_cycles1to6_data <- imputed_cycles1to6_data %>%
  dplyr::filter(control14090_adj != 1)
...
calibration(male_predicted_probabilities, model.frame(male_model_uncontrolled)$highbp14090_adj)
calibration(female_predicted_probabilities, model.frame(female_model_uncontrolled)$highbp14090_adj)
