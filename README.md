...
**Results**: The final HTNPoRT models were discriminating (men c-statistic: 0.86, women c-statistic: 0.88), and well-calibrated in the overall population (men observed v. predicted: 0.88%, women observed v. predicted: 1.47%) and nearly all equity-relevant subgroups (175 out of 177). Age, diabetes, and body mass index were the most influential predictors of hypertension in SHAP-derived risk profiles, while predictability of adiposity measures differed across sex.
