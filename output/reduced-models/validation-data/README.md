...
*   `HTNPoRT-reduced-male-validation-data.csv`: Validation data and predictions for the male reduced model.
*   `HTNPoRT-reduced-female-validation-data.csv`: Validation data and predictions for the female reduced model.
...
male_validation_data$predicted_risk <- predict(male_final_model, newdata = male_validation_data, type = "response")
```
