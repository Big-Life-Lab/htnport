...
subgroup_labels <- list(
  ...
  "mvpa150wk" = "Healthy physical activity",
...
# BMI x WHR plots
print(plot(predict_response(male_final_model, terms = c("hwmdbmi", "whr"), ci_level = NULL)) + 
...
print(plot(predict_response(female_final_model, terms = c("hwmdbmi", "whr"), ci_level = NULL)) + 
