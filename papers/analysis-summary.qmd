...
for (var in rcs_variables) {
  ...
  preds_male$odds_low <- preds_male$conf.low / (1 - preds_male$conf.low)
  preds_male$odds_high <- preds_male$conf.high / (1 - preds_male$conf.high)
  
  preds_male$or_low <- preds_male$odds_low / ref_odds
  preds_male$or_high <- preds_male$odds_high / ref_odds
  
  preds_male$log_or <- log(preds_male$or)
  preds_male$log_or_low <- log(preds_male$or_low)
  preds_male$log_or_high <- log(preds_male$or_high)
  ...
  preds_female$odds_low <- preds_female$conf.low / (1 - preds_female$conf.low)
  preds_female$odds_high <- preds_female$conf.high / (1 - preds_female$conf.high)
  
  preds_female$or_low <- preds_female$odds_low / ref_odds
  preds_female$or_high <- preds_female$odds_high / ref_odds
  
  preds_female$log_or <- log(preds_female$or)
  preds_female$log_or_low <- log(preds_female$or_low)
  preds_female$log_or_high <- log(preds_female$or_high)
