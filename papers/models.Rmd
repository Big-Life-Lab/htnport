...
#   gendmhi = sample(1:2, ####, replace = TRUE), # Binary
...
#   smoke = sample(1:3, ####, replace = TRUE), # 3 categories
...
#   agegroup4 = sample(c("2039", "4059", "6069", "7079"), ####, replace = TRUE), # Categorical age group
...
## Fit male and female models using unweighted male and female data, and compare to weighted models
...
get_or_table(male_model)
get_or_table(male_model_unweighted)

# Get ORs for female weighted and unweighted models
get_or_table(female_model)
get_or_table(female_model_unweighted)
```
...
<!-- ## Model presentation (ignore for now) -->
