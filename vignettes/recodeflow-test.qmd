...
```{r}
recoded_cycle6 <- rec_with_table(cycle6, variables = c("clc_age", "clc_sex", "bpmdpbps", "bpmdpbpd", "sbp_adj"), variable_details = my_variable_details, notes = FALSE) # It can transform multiple variables at once too!
