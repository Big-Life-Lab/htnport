...
cycle1_ace_prescription_data <- rec_with_table(cycle1, c("clinicid", "acemed", recodeflow:::select_vars_by_role("Drugs", my_variables)), variable_details = my_variable_details)
